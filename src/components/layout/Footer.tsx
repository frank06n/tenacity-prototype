    ...
    return (
        <footer className="w-full border-t border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container py-8">
                <div className="flex flex-row gap-8 justify-between px-16 flex-wrap items-start">
                    <div>
                        <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider w-32">About</h3>
                        <div className="flex flex-col gap-2">
                            <Link href="/about" className="text-sm text-muted-foreground hover:text-foreground">Our Story</Link>
                    ...
                    <div>
                        <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider w-32">Resources</h3>
                        <div className="flex flex-col gap-2">
                    ...
                    <div>
                        <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider w-32">Contact</h3>
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="text-sm text-muted-foreground">info@eventshub.com</span>
                        </div>
                    </div>
                    <div>
                        <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider w-32">Follow Us</h3>
                ...
                <div className="mt-8 border-t border-border pt-8">
                    <p className="text-center text-xs text-muted-foreground">
                        &copy; {new Date().getFullYear()} EventsHub. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
